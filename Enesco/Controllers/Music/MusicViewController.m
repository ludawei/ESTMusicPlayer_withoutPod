...
#else
//    track.audioFileURL = [NSURL URLWithString:_musicEntity.musicUrl];     //网络
    
    NSString *documentsPath = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) firstObject];
    track.audioFileURL = [NSURL fileURLWithPath:[documentsPath stringByAppendingPathComponent:_musicEntity.musicUrl]];     //本地
#endif
